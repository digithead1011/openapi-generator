...
|x-java-validation-message-email|Add this property whenever you need to customize the error message on a @Email validation annotation|OPERATION|null|
|x-java-validation-message-notnull|Add this property whenever you need to customize the validation error message on a validation @NotNull annotation|OPERATION|null|
|x-java-validation-message-size|Add this property whenever you need to customize the validation error message on a validation @Size annotation|OPERATION|null|
